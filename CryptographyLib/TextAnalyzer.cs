...
public class TextAnalyzer
{
    ...
    public TextAnalyzer AnalyzeSymbols(bool useAlphabet = true, bool useUppercase = true, bool useBinary = false)
    {
        ...
        else
        {
            ...
            {
                using var sr = new StreamReader(TextPath, Encoding);
    ...
    public TextAnalyzer CalcShannonEntropy()
    {
        ...
        {
            throw new InvalidOperationException($"Call {nameof(AnalyzeSymbols)} before calculating Shannon entropy.");
        }
    ...
    public TextAnalyzer CalcHartleyEntropy()
    {
        ...
        else
        {
            ...
            {
                throw new InvalidOperationException($"Call {nameof(AnalyzeSymbols)} before calculating Hartley entropy.");
            }
    ...
    public TextAnalyzer CalcInformationQuantity(double? shannonEntropy = null, double p = 0, bool useBinary = false)
    {
        if (SymbolsCount is null)
        {
            throw new InvalidOperationException($"Call {nameof(AnalyzeSymbols)} before calculating information quantity.");
        }
