...
public class ElGamalSignature(SysCryptography.HashAlgorithm hasher, BigInteger p, BigInteger g, BigInteger x) : StringSigner<(BigInteger a, BigInteger b)>
{
    private readonly Random _rand = new();
    private readonly BigInteger y = BigInteger.ModPow(g, x, p);

    public SysCryptography.HashAlgorithm Hasher { get; set; } = hasher;
